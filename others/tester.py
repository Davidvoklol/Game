...
def bob(a):
    ...
    for x in range(a):
        ...
        print("bob upgrade cost / bob value:", round(bob_upgrade_cost / bob_value, 2), "/min:", round((bob_upgrade_cost / bob_value) / 60, 2), "\n")
        bob_lvl += 1
        bob_value = (bob_lvl / 2) ** 1.5
        bob_upgrade_cost = bob_value * 60 + bob_lvl ** 2.5
