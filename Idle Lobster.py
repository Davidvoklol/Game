...
class Game:
    def __init__(self, bg):
        ...
        self.display_lobster = tk.Label(self.frame_lobster, text="Lobsters: " + str(golden_lobster), bg=self.bg, font=("Terminal", 25, "bold"))
        ...
        self.button_unlock_autotap = tk.Button(self.platform1, command=self.bob_purchase, text="UNLOCK A NEW LOBSTER: " + str(bob_unlcok_cost) + "$", height=2, width=1, font=("Lucida Console", 20, "bold"), bg="#ab350c", fg="White", activebackground="#ad2d00", activeforeground="white")
        self.button_unlock_autotap.grid(row=2, columnspan=4, sticky=tk.W + tk.E, pady=5)
        ...
        self.button_bob = tk.Button(self.platform1, text="--------", height=2, width=1, font=("Courier", 14, "bold"), bg="#ab350c", fg="White", activebackground="#ad2d00", activeforeground="white")
        ...
        self.label_doodle.grid(row=4, column=0, columnspan=2, sticky=tk.W + tk.E, padx=2.5)
        ...
        self.button_doodle.grid(row=4, column=2, columnspan=2, sticky=tk.W + tk.E, padx=2.5)
        
        self.label_winky = tk.Label(self.platform1, text="Lobster: ---", height=3, width=1, font=("Courier", 14, "bold"), relief="solid", bg="#cc562d")
        self.label_winky.grid(row=5, column=0, columnspan=2, sticky=tk.W + tk.E, padx=2.5)
        ...
        self.button_winky.grid(row=5, column=2, columnspan=2, sticky=tk.W + tk.E, padx=2.5)
        
        self.label_fred = tk.Label(self.platform1, text="Lobster: ---", height=3, width=1, font=("Courier", 14, "bold"), relief="solid", bg="#cc562d")
        self.label_fred.grid(row=6, column=0, columnspan=2, sticky=tk.W + tk.E, padx=2.5)
        ...
        self.button_fred.grid(row=6, column=2, columnspan=2, sticky=tk.W + tk.E, padx=2.5)
        
        self.label_giggles = tk.Label(self.platform1, text="Lobster: ---", height=3, width=1, font=("Courier", 14, "bold"), relief="solid", bg="#cc562d")
        self.label_giggles.grid(row=7, column=0, columnspan=2, sticky=tk.W + tk.E, padx=2.5)
        ...
        self.button_giggles.grid(row=7, column=2, columnspan=2, sticky=tk.W + tk.E, padx=2.5)
        
        self.label_larry = tk.Label(self.platform1, text="Lobster: ---", height=3, width=1, font=("Courier", 14, "bold"), relief="solid", bg="#cc562d")
        self.label_larry.grid(row=8, column=0, columnspan=2, sticky=tk.W + tk.E, padx=2.5)
        ...
        self.button_larry.grid(row=8, column=2, columnspan=2, sticky=tk.W + tk.E, padx=2.5)
    ...
    def check_upgrades(self):
        ...
        if cash >= bob_unlcok_cost and bob_state == "active":
            self.button_unlock_autotap.config(state="active")
        elif cash < bob_unlcok_cost and bob_state == "active":
            self.button_unlock_autotap.config(state="disabled")
    ...
    def bob_purchase(self):
        ...
        self.display_money.config(text="Money: " + str(round(cash, 2)))
        self.button_unlock_autotap.destroy()
        bob_state = "destroyed"
    ...
    def cheat_activation(self, event):
        global cheat_state, cheat_code, cash
        ...
        if cheat_state == "Cancaled" and event.keysym == "Return" and event.state == 131076:
            ...
            cheat_code_input.append(event.keysym)
